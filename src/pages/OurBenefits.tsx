...
const benefits: Array<BenefitType> = [
  {
    ...
    description:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates inventore itaque iste harum repudiandae consequuntur similique. Quidem voluptas deleniti, quaerat illum sapiente molestias ',
  },
  {
...
const OurBenefits = ({ setSelectedPage }: Props) => {
  return (
          ...
          <div>
            <div className='relative'>
              <div className='before:absolute before:-top-20 before:-left-20 before:z-[-1] before:content-abstractwaves'>
                ...
                >
                  <HeaderText>
                    MILLIONS OF HAPPY MEMBERS GET <span className='text-primary-500'>FIT</span>
                  </HeaderText>
                </motion.div>
              </div>
            </div>
